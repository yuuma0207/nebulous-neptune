...
***
# 学部1年
- [ロケットサークル（CREATE）に入部](#ロケットサークルcreateに入部)
...
## 熱力学の教科書の査読をする
- 西森研出身の高橋さんが執筆された『[熱力学・統計力学 熱をめぐる諸相](https://amzn.asia/d/aqj0LJn)』の熱力学パートの査読をした。謝辞に名前が載っている。
...
## 卒業研究
- 原子核理論をテーマにした卒業研究をした。
- Fortran90を使って原子核の計算をするプログラムを作り、卒論を書いた。
    - 研究を引き継いだ人がいろいろ調べた結果、僕のプログラムはいろいろ間違ってたっぽかったけど、卒業したのでまぁ良し。
- 途中でプログラムのバグ取りが嫌になって、計算結果をずんだもんに読み上げさせていた。
    - 標準出力をmp4に変換してずんだもんに読み上げさせていたが、うるさかったので1日でずんだもんは解雇になった。
